...
namespace OptimBaseProf
{
    ...
    internal class CartCell<Item> : IEnumerable<Item>
    {
        ...
        internal CartCell(int cartNumber, int cellNumber)
            : this(cartNumber, cellNumber, string.Empty, string.Empty)
        {
        ...
        public string CartNumberString
        {
            get
            {
                return string.Concat(prefixCart, cartNumber.ToString("00"));
            }
        }
        ...
        public string CellNumberString
        {
            get
            {
                return string.Concat(prefixCell, cellNumber.ToString("00"));
            }
        }
