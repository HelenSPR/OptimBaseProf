...
namespace fo_library.Export.OptimizationExporters
{
    ...
    internal class SawBeam
    {
        ...
        {
            return string.Format("{0,8}{1,3}{2,4}", ManufactName, NumPos, LayoutArea);
        }
        ...
        {
            return CartCell.CartNumberString + "-"; //.ToString("00");
        ...
        public string GetString()
        {
            ...
            Values[26] = _Beam.Profile.Marking;     // Тип профиля
