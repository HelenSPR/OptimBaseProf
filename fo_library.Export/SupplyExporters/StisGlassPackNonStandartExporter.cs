...
{
    internal class StisGlassPackNonStandartExporter : SupplyExporterExcel
    {
        internal StisGlassPackNonStandartExporter(int supplyDocId) : base(supplyDocId) { }
        protected override string FileName
        {
            get { return "Stis_NonStand"; }
        }

        public override void Export()
        {
            string commandText = "fo_supply_get_glasspacks_nonstandart_export";
            ...
            File.WriteAllBytes(FullFileName, Resources.StisGlassPackTempNonStand);
